      ...
      <div class="content-layout">
        ...
        <div class="toc-sidebar">
          ...
          <ul class="toc-list">
            ...
            <li class="toc-item">
              <a href="#accessing-history" class="toc-link" [class.active]="activeSection === 'accessing-history'" (click)="scrollToSection('accessing-history')">
                Accessing History
              </a>
            </li>
            <li class="toc-item">
              <a href="#record-types" class="toc-link" [class.active]="activeSection === 'record-types'" (click)="scrollToSection('record-types')">
                Record Types
              </a>
            </li>
            <li class="toc-item">
              <a href="#analysis-tools" class="toc-link" [class.active]="activeSection === 'analysis-tools'" (click)="scrollToSection('analysis-tools')">
                Analysis Tools
              </a>
            </li>
            <li class="toc-item">
              <a href="#maintenance" class="toc-link" [class.active]="activeSection === 'maintenance'" (click)="scrollToSection('maintenance')">
                Data Maintenance
              </a>
            </li>
          </ul>
